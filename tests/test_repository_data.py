...
class RepositoryDataTests(unittest.TestCase):
    ...
    def test_scanner_and_guardian_share_one_non_cancelling_write_lock(self):
        ...
        self.assertIn("Plain-language final verdict", guardian_workflow)
        self.assertIn("Dead links found", guardian_workflow)
        self.assertIn("Dead-link repair", guardian_workflow)
        self.assertIn("Quarantine restore", guardian_workflow)
