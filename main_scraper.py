...
# ==============================================================================
# 🎬 ৬. সমান্তরাল পাইপলাইন প্রসেসর (Ultra Flexible 1080p+ Header & '3' Match)
# ==============================================================================
async def process_movie_parallel_pipeline(browser, movie_url, movie_idx, default_category_name):
    ...
    try:
        ...
        # 🎯 অল্টারনেটিভ ও ফ্লেক্সিবল হেডার ফিল্টার (কন্টেইনার ক্লাসের ওপর নির্ভরতামুক্ত)
        target_buttons = await page.evaluate(r"""
            () => {
                let matches = [];
                let seenUrls = new Set();

                // ১. সারা পেজের সব হেডার ট্যাগ স্ক্যান
