...
async def process_movie_parallel_pipeline(browser, movie_url, movie_idx, default_category_name):
    ...
    try:
        ...
        # 🎯 বাটন এক্সট্র্যাক্টর (নিখুঁত কার্ড এবং সিঙ্গেল মুভি ফিল্টারিং)
                ...
                if (epCards.length > 0) {
                    ...
                    headers.forEach(h => {
                        ...
                        if (hText.includes('1080p') || hText.includes('2160p') || hText.includes('4k') || hText.includes('hevc')) {
                            ...
                            if (container) {
                                let watchBtn = container.querySelector('a.dlbtn-watch, a[href*="generate.php"]');
