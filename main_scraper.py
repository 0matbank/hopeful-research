...
async def main():
    ...
    # 📝 history.txt থেকে সঠিক পোস্ট ইউআরএলগুলোর লিস্ট লোড করা
    history_urls_list = []
    scraped_history = set()
    ...
    # মুভির নামের সাথে history.txt-এর আসল URL মেলাবার ফাংশন
    ...
    if existing_movies:
        ...
        for m in existing_movies:
            ...
            # লিংক ডেড থাকলে history.txt থেকে আসল পোস্ট URL বের করে প্লে-রাইট কিউতে বসানো
