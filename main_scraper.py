...
# ==============================================================================
# 📑 শক্তিশালী আউটপুট টেক্সট পার্সার (মুভি ও সিরিজ উভয় স্ট্রাকচার ব্যাকআপ রাখার জন্য)
# ==============================================================================
def parse_existing_output_file(file_path):
    ...
    try:
        ...
        for block in blocks:
            ...
            year_str = year_m.group(1).strip() if year_str else "N/A"
...
# ==============================================================================
# 🎬 ৬. সমান্তরাল পাইপলাইন প্রসেসর (বাটন আইডেন্টিফিকেশন ১০০% সুরক্ষিত)
# ==============================================================================
...
# ==============================================================================
# 🎯 ৭. মেইন কন্ট্রোলার (TXT, JSON, M3U + Metadata + Educational Notice + History Filter)
# ==============================================================================
async def main():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            # 📝 আগের সেভ হওয়া ডেটা লোড করা (কোনো ডেটা মুছবে না)
            ...
            # 📝 পুরানো + নতুন সব পোস্ট একত্রিত করা
            all_movies = existing_movies + new_movies_list

            # 🎯 [POSTER AUTO-REPAIR] মিসিং পোস্টার ব্যাকফিল করা
            for m in all_movies:
            ...
            # 📝 ১. টেক্সট ফাইল জেনারেট ও রাইট করা (মেটাডাটা ও নোটিশ সহ)
            ...
            # 📝 ২. JSON ফাইল জেনারেট ও রাইট করা (মেটাডাটা সহ)
            json_payload = {
                "category_info": {
            ...
            # 📝 ৩. M3U প্লেলিস্ট ফাইল জেনারেট ও রাইট করা (মেটাডাটা ও নোটিশ সহ)
            ...
            print(f"✅ Successfully updated TXT, JSON, and M3U files for [{target_category_name}]!", flush=True)
